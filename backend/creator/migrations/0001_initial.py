    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('----', 'Undefined')], default='----', max_length=7, verbose_name='Gender')),
                ...
                ('auth_provider', models.CharField(blank=True, choices=[('Email', 'Email'), ('Github', 'Github'), ('Google', 'Google'), ('Twitter', 'Twitter')], default='Email', max_length=50, null=True, verbose_name='Authentication Provider')),
                ('auth_provider_id', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='Authentication Provider ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The name of this Openuser profile.', max_length=20, validators=[django.core.validators.RegexValidator(message='Must begin and end with a letter. Maximum of 2 whitespaces', regex='^[a-zA-Z]+(\\s?[\\w-]+\\s?[a-zA-Z]+)?$'), django.core.validators.MinLengthValidator(limit_value=4)], verbose_name='Name')),
                ('description', models.CharField(blank=True, max_length=255, null=True, verbose_name='Description')),
                ('profiles', models.IntegerField(default=5, help_text='Number of openuser profiles to create, default is 5', validators=[django.core.validators.MaxValueValidator(limit_value=50), django.core.validators.MinValueValidator(limit_value=5)], verbose_name='Profiles')),
                ('profile_password', models.CharField(default='p@ssw0rd', help_text='The password to use for all profiles', max_length=15, validators=[django.core.validators.RegexValidator(inverse_match=True, message='Profile password cannot contain spaces', regex='\\s'), django.core.validators.MinLengthValidator(limit_value=8)], verbose_name='Profile password')),
                ...
                ('status', models.CharField(choices=[('Creating', 'Creating'), ('Created', 'Created')], default='Created', help_text='Openuser status', max_length=50, verbose_name='Status')),
